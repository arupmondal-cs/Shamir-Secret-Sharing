...
def Shamir_Secret():
    ...
    print("\nSecret recovered from minimum subset of shares:             ",recover_secret(shares[:threshold], threshold))
    print("Secret recovered from a different minimum subset of shares: ",recover_secret(shares[(0-threshold):], threshold))
